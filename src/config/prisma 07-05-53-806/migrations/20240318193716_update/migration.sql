...
CREATE TABLE "new_api_users" (
    ...
    "email" TEXT NOT NULL,
    "password" TEXT,
    "tmpPassword" TEXT NOT NULL DEFAULT '',
    "roleId" TEXT,
...
INSERT INTO "new_api_users" ("createdAt", "email", "id", "invited", "name", "password", "roleId", "verified", "verifyTolkien") SELECT "createdAt", "email", "id", "invited", "name", "password", "roleId", "verified", "verifyTolkien" FROM "api_users";
